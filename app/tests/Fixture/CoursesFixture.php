...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_enabled' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'start_date' => '2025-02-10 21:32:56',
                'end_date' => '2025-02-10 21:32:56',
                'is_enabled' => 1,
                'create_at' => '2025-02-10 21:32:56',
                'delete_at' => '2025-02-10 21:32:56',
            ],
        ];
        parent::init();
    }
