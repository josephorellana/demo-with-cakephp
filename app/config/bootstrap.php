...
Configure::write('templates', [
    'form' => [
        ...
        'input' => '<input type="{{type}}" name="{{name}}" {{attrs}} class="form-control{{class}}{{validityClass}}" />',
        ...
        'select' => '<select name="{{name}}" {{attrs}} class="form-select{{class}}{{validityClass}}">{{content}}</select>',
        'textarea' => '<textarea name="{{name}}" {{attrs}} class="form-control{{class}}{{validityClass}}">{{value}}</textarea>',
